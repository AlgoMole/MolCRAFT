...
class VinaDockingTask(BaseDockingTask):
    ...
    @classmethod
    def from_generated_mol(cls, ligand_rdmol, ligand_filename, protein_filename=None, protein_root='./data/crossdocked', **kwargs):
        # load original pdb
        ...
        elif protein_filename is not None and 'sbdd_data' not in protein_root:

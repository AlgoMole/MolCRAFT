...
class RecoverCallback(Callback):
    ...
    def setup(self, trainer: Trainer, pl_module: LightningModule, stage: str) -> None:
        ...
        if os.path.exists(self.latest_ckpt) and self.resume:
            ...
            pl_module.load_from_checkpoint(self.latest_ckpt, config=pl_module.cfg)
...
class EMACallback(pl.Callback):
    ...
    def on_validation_start(
        ...
        # fix from: https://github.com/Lightning-AI/pytorch-lightning/issues/10914#issuecomment-1007088557

...
if __name__ == "__main__":
    ...
    parser.add_argument("--objective", type=str, default=None, choices=[None, 'vina', 'qed', 'sa', 'lipinski', 'qed_sa', 'vina_qed', 'vina_sa', 'vina_qed_sa', 'vina_qed_sa_lipinski'])
    parser.add_argument("--guide_mode", type=str, default='param_naive', choices=[None, 'param_naive', 'param_logit', 'sample_one', 'sample_best', 'sample_mean', 'data_naive', 'data_logit'])
    parser.add_argument('--pos_grad_weight', type=float, default=1.0)
    parser.add_argument('--type_grad_weight', type=float, default=1.0)
    parser.add_argument("--interpolate_coef", type=float, default=0.5)
    ...
    classifier_list = []
    work_dir = '/sharefs/qiukeyue/project/BFN4MolOpt'
    postfix = ''

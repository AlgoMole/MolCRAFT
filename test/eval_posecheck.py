...
""" 
First we need to convert the pt file to a list of molecules
You may find it useful to use the following command
...
...     with Chem.SDWriter(f'mols/{i}.sdf') as w:
...         w.write(mol)                     
... 
>>> 
...
...     mol.SetProp('vina_minimize', str(r['vina']['minimize'][0]['affinity']))
...     mol.SetProp('vina_dock', str(r['vina']['dock'][0]['affinity']))
...     with Chem.SDWriter(f'kgdiff/{i}.sdf') as w:
...             w.write(mol)
... 
"""
